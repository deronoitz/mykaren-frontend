    ...
    <div style={{ padding: '30px 0' }}>
      <div className="step-container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 2 && <Details form={form} loading={loading} circleName={circleName} onClickPrev={() => setStep(1)} />}
        </form>
        <Modal
        ...
        >
          <div className='f f-ctr mdl f-c'>
            ...
            <Title level={3} strong style={{ textAlign: 'center' }}>
              Yeaayy, your circle<br />is created!
            </Title>
            ...
            <div style={{ marginTop: 20 }} className='f f-c f-ctr mdl'>
              <Button onClick={() => router.push(`/circle/${slug}`)} type='primary' style={{ marginBottom: 10 }}>Go to Circle Menu</Button>
