          ...
          <div className='item'>
            ...
            <div className='wrapper'>
              <Alert
                ...
                description={<Text style={{ fontSize: 12 }}>You need to upload the proof of transfer to verify the transaction.</Text>}
                type="warning"
                action={
                  <Button type='primary'>Upload proof of transfer</Button>
                }
                showIcon
                style={{ marginBottom: 20 }}
              />
              <Text style={{ fontSize: 16, fontWeight: 500, color: 'var(--titleColor)', marginRight: 12 }}>Purchased Items</Text>

              {circle.map((i, index) => <CircleProduct key={index} data={i} />)}
