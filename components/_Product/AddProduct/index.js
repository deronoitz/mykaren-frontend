        ...
        >
          <div className='f f-ctr mdl f-c'>
            ...
            <Title level={3} strong style={{ textAlign: 'center' }}>
              Yeaayy, your product<br />is added!
            </Title>
            <Typography.Text style={{ display: 'block', textAlign: 'center', maxWidth: '70%' }}>
              <span style={{fontWeight: 600}}>{form.getValues('name')}</span> is successfully added. Do you want to add another product?
            </Typography.Text>
            <div style={{ marginTop: 20 }} className='f f-c f-ctr mdl'>
              <Button onClick={() => handleAddNew()} type='primary' style={{ marginBottom: 10 }}><PlusOutlined />Add Another Product</Button>
