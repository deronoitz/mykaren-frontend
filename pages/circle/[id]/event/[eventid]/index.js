  ...
  return (
    <CircleLayout>
      ...
      <div className="upcoming-event">
        <Title level={4} style={{ marginBottom: 20 }}>Overview</Title>
        <div className="f">
          <div className="f mdl f-btw" style={{ width: "45%" }}>
            <div className="statisticItem f f-c">
              <Title strong style={{ fontSize: 48, margin: 0 }}>C-12b</Title>
              <Text style={{ fontSize: 14 }}>Booth Number</Text>
              <LineDecoration m="8px 0 0 0" c="#F72963" />
            </div>

            <div className="statisticItem f f-c">
              <Title strong style={{ fontSize: 48, margin: 0 }}>4</Title>
      ...
      <div className="upcoming-event" style={{ marginBottom: 40, paddingBottom: 26 }}>
        <Title level={4} style={{ marginBottom: 20 }}>Announcement</Title>
          ...
          renderItem={item => (
            <List.Item>
              <List.Item.Meta
                ...
                title={
                  <React.Fragment>
                    <a href="https://ant.design" style={{ fontWeight: 600, color: "rgba(0,0,0,.85)", marginRight: 10 }}>{item.title}</a>
                    {
                      (item.tag || []).map(tag => <Tag color="orange">{tag}</Tag>)
                    }
                  </React.Fragment>
                }
                description={
