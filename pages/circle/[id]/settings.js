  ...
  return (
    <CircleLayout>
      ...
      <div className="wrapper">
        <div>
          <Title level={4} style={{ margin: 0 }}>Update Circle Details</Title>
          <div style={{margin: "30px 0"}}>
            <Label>Logo</Label>
            <Text style={{ fontSize: 12, display: "block", marginBottom: 11 }}>Karen recommend an image of<br />at least 512 x 512px for the logo.</Text>
            <Button type="primary" ghost>Upload logo</Button>
          </div>
          ...
          <div style={{ width: 360, margin: "30px 0" }}>
            ...
            <Select bordered={false} mode="tags" style={{ width: 360 }} placeholder="Click to choose" size="large">
              <Option key="1" value="1">Music</Option>
              <Option key="2" value="2">Game</Option>
              <Option key="3" value="3">Illustration</Option>
            </Select>
          </div>
          ...
          <div className="f mdl f-btw">
            <div>
              <Title level={4} style={{ margin: 0 }}>Delete Circle</Title>
              <Text style={{ fontSize: 12, color: "var(--contentColor)" }}>Once you delete a circle, there is no going back.</Text>
            </div>
            <Button>
              <DeleteOutlined />
            Delete Circle
