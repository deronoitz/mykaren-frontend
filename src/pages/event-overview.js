...
import Rundown from "components/commons/Rundown";
import Header from "components/scenes/EventOverview/Header";
...
export default function EventOverview() {
  ...
  return (
    <div>
      ...
      <PublicLayout>
        <div style={{ position: "absolute", zIndex: -1, opacity: 0.3 }}>
          ...
          <div className="container" style={{ padding: "0 100px" }}>
            <div className="f mdl f-btw">
              <div>
                ...
                <Typography.Text
                  style={{ maxWidth: 500, display: "block", fontSize: 16, lineHeight: 2, marginTop: 20 }}
                >
                  Laboris aliquip laborum proident excepteur. Officia sit ut cillum commodo eu irure cillum dolor nulla
                  eiusmod. Exercitation laborum veniam id esse reprehenderit culpa ipsum dolor culpa voluptate eiusmod
                  sunt incididunt.
                </Typography.Text>
              </div>
              <div className="logo">
        ...
        <div className="statistic">
          <div className="container f f-btw">
            <div className="statisticItem f f-c">
              <Typography.Title strong style={{ fontSize: 64, margin: 0 }}>
                7
              </Typography.Title>
        ...
        <div className="statistic" id="venue" style={{ scrollMarginTop: 146 }}>
          <div className="container" style={{ padding: "50px 0" }}>
            ...
            <div className="f mdl">
              <div style={{ width: "50%" }}>
                <Typography.Title level={3}>SMESCO Exhibition Hall</Typography.Title>
                <Typography.Text style={{ fontSize: 16, display: "block", maxWidth: "80%" }}>
                  Jl. Gatot Subroto No.kav. 94, RT.11/RW.3, Pancoran, Kec. Pancoran, Kota Jakarta Selatan, Daerah Khusus
                  Ibukota Jakarta 12780
                </Typography.Text>
              </div>
              <div>
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.165765879775!2d106.83400501473204!3d-6.241872295481788!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5d2d95edae3%3A0xd35803a2d4d1c223!2sSmesco%20Indonesia!5e0!3m2!1sen!2sid!4v1612708870730!5m2!1sen!2sid"
                  width="600"
                  height="400"
                  frameBorder="0"
                  style={{ border: 0 }}
