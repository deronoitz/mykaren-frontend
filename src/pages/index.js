      ...
      <PublicLayout>
        ...
        <div className="container f f-c f-ctr" style={{ minHeight: 550 }}>
          <Typography.Title level={1} style={{ maxWidth: 665 }}>
            Learn to managing creative product at any scale with MyKaren
          </Typography.Title>
          <Typography.Text className="subTitle">Karen will always help you to manage your circle</Typography.Text>
          <div className="f mdl" style={{ marginTop: 45 }}>
            <Button size="large" type="primary" style={{ marginRight: 55 }}>
              Get Started
            </Button>
            <Link href="">
        ...
        <div className="features">
          <div className="container">
            <div className="f f-ctr mdl f-c">
              <Typography.Title level={1}>Bring your circle onto next level</Typography.Title>
            ...
            <div className="f f-w" style={{ margin: "70px 0" }}>
              <div className="featureItem f mdl">
                ...
                <div className="f f-c" style={{ marginLeft: 35 }}>
                  ...
                  <Typography.Text>
                    Your circle member will receive reputation point every finishing the task you given.
                  </Typography.Text>
              ...
              <div className="featureItem f mdl">
                ...
                <div className="f f-c" style={{ marginLeft: 35 }}>
                  ...
                  <Typography.Text>
                    We will help you to predict some popular fandom in day, week, and month.
                  </Typography.Text>
