...
export default function Payment() {
  ...
  return (
    <div>
      ...
      <Text style={{ fontSize: 16, fontWeight: 500, color: "var(--titleColor)", display: "block", marginTop: 20 }}>
      ...
      <Radio.Group style={{ marginTop: 22 }} defaultValue={1} value={radio} onChange={handleRadio}>
        ...
        <Radio value={2} style={{ display: "flex" }} disabled>
          <div className="f f-c" style={{ marginTop: -2, marginLeft: 5 }}>
            <Text style={{ fontWeight: 500, color: "var(--titleColor)" }}>Another person</Text>
            <Text style={{ fontSize: 12 }}>You need to fill some information about the person</Text>
            {radio === 2 && (
      ...
      <Text style={{ fontSize: 16, fontWeight: 500, color: "var(--titleColor)", display: "block", marginBottom: 22 }}>
        Payment method
      </Text>
