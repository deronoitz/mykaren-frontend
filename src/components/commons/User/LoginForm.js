    ...
    <div className="form">
      ...
      <form onSubmit={onSubmit}>
        ...
        <Controller
          ...
          defaultValue=""
          render={({ onChange, value }) =>
            <Input onChange={onChange} value={value} placeholder="Password" type="password" style={{ marginBottom: 20 }} />
          }
        />
        <Controller
          control={form.control}
          ...
          defaultValue={false}
          render={({ onChange, value }) =>
            <Checkbox onChange={e => onChange(e.target.checked)} checked={value}>Remember me</Checkbox>
          }
        />
        <div style={{ marginTop: 20, marginBottom: 10 }}>
          <Button loading={loading} block size="large" type="primary" htmlType="submit">Login</Button>
        </div>
      </form>
      <Typography.Text>
        Need an account?
